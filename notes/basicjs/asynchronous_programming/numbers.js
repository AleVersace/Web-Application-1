...
sqlite.Database('/home/ale/Documents/uni/magistrale/webapp1/notes/basicjs/asynchronous_programming/numbers.sqlite', (err) => {
    if(err) throw err;
});     // It's asyncronous, so we have to provide the exception handler


// Queries
db.all("SELECT * FROM numbers", (err, rows) => {        // This call will go ahead asyncronously and call the callback at the end.
